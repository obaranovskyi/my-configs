...
vim.opt.conceallevel = 2 -- obsidian plugin requires that
...
vim.cmd([[
  let g:markdown_fenced_languages = ['html', 'python', 'bash=sh', 'javascript', 'typescript', 'vim', 'css', 'c', 'dockerfile', 'json', 'csharp', 'sql']
]])
